...
Las observaciones de uso todavía sin triar de cada versión se recogen aparte, en `docs/notas-de-uso-<versión>.md` (por ejemplo [notas de uso 1.5.4](docs/notas-de-uso-1.5.4.md), [notas de uso 1.5.7](docs/notas-de-uso-1.5.7.md) y [notas de uso 1.6.0](docs/notas-de-uso-1.6.0.md)), y se articulan en este backlog o en [Plan camino a 1.6.0](docs/plan-1.6.0.md) al convertirse en trabajo.
