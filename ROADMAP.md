...
- **Casillas de verificación — árbol visual verificado en 1.5.9; revalidación física pendiente.** La Etapa 18 añadió una aplicación de prueba WinUI que resuelve el `ControlTemplate` real: el `Rectangle` del glifo recibe radio 4 desde `CornerRadius`, y la inspección visual de esta estación mostró el mismo redondeo. La hipótesis de radios fijos en el XAML de tema queda descartada y no se justifica un cuarto parche de producción sin un defecto reproducible. La observación física de 1.5.7 se conserva en [notas de uso 1.5.7](docs/notas-de-uso-1.5.7.md#2-casillas-de-verificación-siguen-con-ángulos-rectos-después-de-un-tercer-abordaje) y debe repetirse en esa estación antes de cerrar la discrepancia; resultado completo en la etapa 18 de [`docs/plan-1.6.0.md`](docs/plan-1.6.0.md#etapa-18--casillas-de-verificación-prueba-de-árbol-visual-y-cuarto-intento-159).
...
Las observaciones de uso todavía sin triar de cada versión se recogen aparte, en `docs/notas-de-uso-<versión>.md` (por ejemplo [notas de uso 1.5.4](docs/notas-de-uso-1.5.4.md), [notas de uso 1.5.7](docs/notas-de-uso-1.5.7.md) [notas de uso 1.6.0](docs/notas-de-uso-1.6.0.md) y [notas de uso 1.6.1](docs/notas-de-uso-1.6.1.md)), y se articulan en este backlog o en [Plan camino a 1.6.0](docs/plan-1.6.0.md) al convertirse en trabajo.
