...
Integración auditada el 30 de junio de 2026 sobre la rama `codex/version-1.5`, versión `1.5.0-alpha.7`. Los frentes de trabajo están combinados y la certificación física continúa.
...
| Pruebas automatizadas | Correcta | 75 pruebas NUnit sobre el código integrado. |
| Versionado | Coherente para alpha | Proyecto e instalador `1.5.0-alpha.7`; manifiesto `1.5.0.0`. Debe cambiarse solo al preparar la candidata. |
