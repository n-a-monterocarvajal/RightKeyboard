...
| Lenguaje de actualización | Ejecutar el instalador sobre una versión existente | El título de ventana, el título y explicación de la página y la acción principal dicen **Actualizar**, no **Instalar**; se anuncia que se conservarán preferencias e inicio automático | Manual |
