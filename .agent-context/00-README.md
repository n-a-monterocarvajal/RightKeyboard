...
- Observaciones de uso sin triar por versión: `docs/notas-de-uso-<versión>.md` (p. ej. `docs/notas-de-uso-1.5.4.md` y `docs/notas-de-uso-1.5.7.md`). Léelas al buscar pendientes; al convertir una en trabajo, trasládala al backlog y deja la referencia.
