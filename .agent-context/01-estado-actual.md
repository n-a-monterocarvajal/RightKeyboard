...
Snapshot actualizado el **2026-09-24** al publicar 1.6.2. Contrastar siempre con `git status`, `git log -1 --oneline` y los metadatos de versión del checkout actual.
...
- La agrupación requiere validación física con dos teclados y cambio de puerto en la estación real, incluido desde 1.6.1 el recorrido del dispositivo ignorado que cambia de puerto; la VM no expone passthrough directo.
